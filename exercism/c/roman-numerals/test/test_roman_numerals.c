...
static void test_error_conversion(int number) {
    char *result = to_roman_numeral(number);
...
static void test_zero_yields_null(void)
{
   //TEST_IGNORE();
...
static void test_4000_yields_null(void)
{
   //TEST_IGNORE();
   test_error_conversion(4000);
}
...
int main(void)
{
   ...
   RUN_TEST(test_zero_yields_null);
   RUN_TEST(test_4000_yields_null);
